...
void setup() {
  ...
  unsigned char input[1024] = "Test Stringabcde";
  mbedtls_mpi_init( &N ); 
  mbedtls_mpi_init( &E );
  unsigned char hash[32];
  char filename[512] = "test.sig";
  ...
  mbedtls_md( mbedtls_md_info_from_type( MBEDTLS_MD_SHA256 ), input, 16, hash);
  ...
  if (ret != 0) {
      Serial.printf(" Signature is not valid!!!\n");
  }
  else {
      Serial.printf(" Signature is valid!\n");
  }
